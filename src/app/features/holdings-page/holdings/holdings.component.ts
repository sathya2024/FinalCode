      ...
      .subscribe({
        next: (data) => {
          ...
          this.investments = data
            ...
            .map((inv) => ({
              ...inv,
              symbol: inv.stockName || inv.schemeName || inv.fixedIncomeName || null, 
              currentPrice: null,
              currentValue: null,
              gainLoss: null,
...
updateCurrentPrices(): void {
  ...
  calculateTotals(): void {
    ...
    for (const inv of this.investments) {
      if (inv.type === 'Stock') {
        ...
        const currentPrice = inv.currentPrice || inv.investmentAmount; 
  ...
  openEditInvestmentModal(inv: any) {
    ...
    this.showInvestmentModal = true;
    console.log('Selected Investment for Edit:', this.selectedInvestment); 
